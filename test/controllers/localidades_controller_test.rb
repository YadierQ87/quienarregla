...
class LocalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localidade" do
    assert_difference('Localidade.count') do
      post localidades_url, params: { localidade: { municipios_id: @localidade.municipios_id, nombre: @localidade.nombre } }
    end
  ...
  test "should update localidade" do
    patch localidade_url(@localidade), params: { localidade: { municipios_id: @localidade.municipios_id, nombre: @localidade.nombre } }
