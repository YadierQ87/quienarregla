...
class MunicipiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipio" do
    assert_difference('Municipio.count') do
      post municipios_url, params: { municipio: { nombre: @municipio.nombre, provincia_id: @municipio.provincia_id } }
    end
  ...
  test "should update municipio" do
    patch municipio_url(@municipio), params: { municipio: { nombre: @municipio.nombre, provincia_id: @municipio.provincia_id } }
