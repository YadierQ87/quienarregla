...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference('Cliente.count') do
      post clientes_url, params: { cliente: { nombre: @cliente.nombre, telf_contacto: @cliente.telf_contacto } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { nombre: @cliente.nombre, telf_contacto: @cliente.telf_contacto } }
