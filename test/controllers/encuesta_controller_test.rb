...
class EncuestaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encuestum" do
    assert_difference('Encuestum.count') do
      post encuesta_url, params: { encuestum: { aspectoEvaluar: @encuestum.aspectoEvaluar, fecha: @encuestum.fecha, nombre: @encuestum.nombre, pregunta: @encuestum.pregunta, puntuacion: @encuestum.puntuacion } }
    end
  ...
  test "should update encuestum" do
    patch encuestum_url(@encuestum), params: { encuestum: { aspectoEvaluar: @encuestum.aspectoEvaluar, fecha: @encuestum.fecha, nombre: @encuestum.nombre, pregunta: @encuestum.pregunta, puntuacion: @encuestum.puntuacion } }
